                    ...
                    <ul className="text-sm flex flex-col gap-1 font-medium">
                        {[
                            ...
                            <li
                                key={index}
                                className="group"
                                onMouseEnter={() => setHoveredIndex(index + 4)} // Offset index for bottom links
                                onMouseLeave={() => setHoveredIndex(null)}
                            >
                                <Link href={`/${item.name.toLowerCase().replace(/ /g, '-')}`}>
                                    <div onClick={navHandler}
                                        ...
                                        >
                                            ...
                                            {item.icon && (
                                                <span className="inline-block">
                                                    <img src="/icon/footer/open_2.svg" className="w-5 h-5 object-cover" />
                                                </span>
                                            )}
                                        </div>
                                    </div>
