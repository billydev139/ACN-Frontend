  ...
  return (
    <div>
      <div className="bg-[#202020] text-gray-200 flex flex-col items-center relative w-full overflow--hidden">
        ...
        <Head>
          <title>
            Autocenter Niederbipp - Zuverlässig Reparaturen & Services am neuen
            Standort
          </title>
          ...
          <div className="md:w-[75%] w-full mt-32 ">
            <main className="container mx-auto md:px-4 px-3 py-8">
              <h1 className="text-3xl font-bold text-start mb-4 text-brGold">
                Autocenter Niederbipp - Zuverlässig Reperaturen & Services am
                neuen Standort
              </h1>
              ...
              <p className="text-lg mb-4 text-white">
                Das Autocenter Niederbipp bietet Ihnen umfassende Reparatur- und
                Serviceleistungen für alle Fahrzeugmarken am neuen Standort. Von
                routinemäßigen Inspektionen über Ölwechsel bis hin zu komplexen
                Reparaturen – unser qualifiziertes Team sorgt dafür, dass Ihr
                Auto in Bestform bleibt.
              </p>

              <p className="text-gray-400 mb-8">
                Wir verwenden modernste Diagnose- und Reparaturtechniken, um
                sicherzustellen, dass alle Arbeiten effizient und präzise
                durchgeführt werden. Vertrauen Sie auf unsere langjährige
                Erfahrung im Bereich Reparaturen & Services.
              </p>

              <p className="text-lg mb-4 text-brGold">
                Besuchen Sie uns am neuen Standort oder erfahren Sie mehr über
                unsere Reparatur- und Serviceangebote auf unserer Website:
                Autocenter Niederbipp - Reparaturen & Services.
              </p>
