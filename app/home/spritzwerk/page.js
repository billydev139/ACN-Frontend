  ...
  return (
    <div>
      <div className="bg-[#202020] text-gray-200 flex flex-col items-center relative w-full overflow--hidden">
        ...
        <Head>
          <title>
            Autocenter Niederbipp - Proffesionelles Spritzwerk für erstklassige
            Lackierungen
          </title>
        ...
        <header className="relative w-full h-auto">
          ...
          <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
            <div className="text-center">
              ...
              <AnimatedText>
                <h1 className="text-6xl text-brGold font-bold">Spritzwerk</h1>
              </AnimatedText>
          ...
          <div className="md:w-[75%] w-full mt-32 ">
            <main className="container mx-auto md:px-4 px-3 py-8">
              <h1 className="text-3xl font-bold text-start mb-4 text-brGold">
                Autocenter Niederbipp - Proffesionelles Spritzwerk für
              ...
              <p className="text-lg mb-4 text-white">
                Das Spritzwerk des Autocenter Niederbipp bietet Ihnen
                professionelle und hochwertige Lackierungen für alle
                Fahrzeugtypen. Ob Neulackierungen, Reparaturlackierungen oder
                Sonderlackierungen – unser erfahrenes Team setzt Ihre Wünsche
                mit höchster Präzision um.
              </p>

              <p className="text-gray-400 mb-8">
                Wir verwenden modernste Technik und erstklassige Materialien, um
                sicherzustellen, dass Ihr Fahrzeug in neuem Glanz erstrahlt.
                Vertrauen Sie auf unsere Expertise und unser Engagement für
                Qualität und Nachhaltigkeit.
              </p>

              <p className="text-lg mb-4 text-brGold">
                Besuchen Sie uns am neuen Standort oder erfahren Sie mehr über
                unser Spritzwerk auf unserer Website: Autocenter Niederbipp -
                Spritzwerk.
              </p>
