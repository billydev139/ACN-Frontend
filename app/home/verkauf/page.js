  ...
  return (
    <div>
      <div className="bg-[#202020] text-gray-200 flex flex-col items-center relative w-full overflow--hidden">
        ...
        <Head>
          <title>
            Autocenter Niederbipp - Ihr Partner für Autoverkauf und Ankauf neuen
            Standort
          </title>
        ...
        <header className="relative w-full h-auto">
          ...
          <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
            <div className="text-center">
              ...
              <AnimatedText>
                <h1 className="text-6xl text-brGold font-bold">
                  Verkauf & Ankauf
                </h1>
              </AnimatedText>
          ...
          <div className="md:w-[75%] w-full mt-32 ">
            <main className="container mx-auto md:px-4 px-3 py-8">
              <h1 className="text-3xl font-bold text-start mb-4 text-brGold">
                Autocenter Niederbipp - Ihr Partner für Autoverkauf und Ankauf
                am neuen Standrot
              </h1>
              ...
              <p className="text-lg mb-4 text-white">
                Das Autocenter Niederbipp bietet am neuen Standort umfassende
                Dienstleistungen rund um Autoverkauf, Ankauf und Carrosserie.
                Unser engagiertes Team steht Ihnen mit einer breiten Auswahl an
                hochwertigen Gebrauchtwagen zur Seite und garantiert
                erstklassige Beratung. Egal, ob Sie ein Auto kaufen, verkaufen
                oder eine professionelle Carrosserie-Reparatur benötigen – bei
                uns finden Sie die besten Lösungen für Ihre Bedürfnisse.
                Besuchen Sie uns und entdecken Sie unsere Angebote.
              </p>

              <p className="text-gray-400 mb-8">
                Mehr Informationen erhalten Sie auf unserer Website: Autocenter
                Niederbipp - Verkauf.
              </p>

              <p className="text-lg mb-4 text-brGold">
                Unser Hochleistungsglas SILVERSTAR Combi Grau 40/22 T war die
                optimale Wahl für das elegante, asymmetrische Design und die
                glänzenden Glasfassaden von One Za'abeel. Das neutrale,
                beschichtete Glas bietet eine hohe Lichtdurchlässigkeit und
                sorgt für Energieeinsparungen. Die
                Doppel-Silber-Magnetron-Sputter-Technologie garantiert dabei
                maximalen Sonnenschutz und Wärmedämmung.
              </p>
